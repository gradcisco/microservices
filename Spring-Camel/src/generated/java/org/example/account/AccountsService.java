 ...
 * 2020-05-30T10:37:22.819+03:00
 * Generated source version: 3.3.6
 *
 */
@WebServiceClient(name = "AccountsService",
                  wsdlLocation = "file:/C:/Users/dmutegi/eclipse-workspace/Spring-Camel/src/main/resources/Account.wsdl",
                  targetNamespace = "http://www.example.org/Account/")
public class AccountsService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.example.org/Account/", "AccountsService");
    public final static QName AccountsPort = new QName("http://www.example.org/Account/", "AccountsPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/dmutegi/eclipse-workspace/Spring-Camel/src/main/resources/Account.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountsService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/dmutegi/eclipse-workspace/Spring-Camel/src/main/resources/Account.wsdl");
        }
        WSDL_LOCATION = url;
    }
